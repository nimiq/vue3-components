...
const l = {
...
}, c = /* @__PURE__ */ e("g", { fill: "currentColor" }, [
  /* @__PURE__ */ e("path", {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
  ...
  /* @__PURE__ */ e("path", { d: "M7.62 13.4a.24.24 0 0 0 .06-.24A4.32 4.32 0 0 1 7.5 12a4.5 4.5 0 0 1 5.66-4.33c.09.03.18 0 .24-.06l1.94-1.94a.25.25 0 0 0-.1-.42c-1.05-.34-2.14-.5-3.24-.5C7.7 4.69 3.4 7.7.81 10.55a2.15 2.15 0 0 0 0 2.9 21.21 21.21 0 0 0 3.43 3.03c.1.07.24.06.33-.03l3.05-3.05z" })
], -1), a = [
  c
];
function r(n, d) {
...
//# sourceMappingURL=vue3-components38.js.map
