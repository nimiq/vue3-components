<template>
    <div class="carousel" :class="{ disabled }" :ref="root$">
        <div v-for="(entry, index) in entries" :ref="entry" :key="refs$[index]"
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        function _shouldHide(entry: string): boolean {
            ...
            return false; // TODO: the function needs to always return a boolean, so added this but not sure if it's correct
        }
